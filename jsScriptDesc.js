        ...
        if(response.data[i].name === "Profile Pictures"){
          FB.api(
            ...
            function(response){
              ...
              console.log(pic);
              $('#main h2').append("<h5>This is Your Facebook Profile Picture:</h5>" + "<img id='preview1' style='width:200px;height:150px' src=" + pic + " class=\"img-thumbnail\"/> "+"</br>");
